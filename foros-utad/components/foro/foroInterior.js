  ...
  <div style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
    ...
    <div style={{ display: 'flex', flexDirection: 'row', width: '100%' }}>
      ...
      <div style={{ width: '100%', marginTop: '60px'}}>
        <div className="bg-gray-200 rounded min-w-[300px] max-w-screen-lg w-full h-screen my-8 mx-auto flex flex-col justify-between">
          <div style={{ position: 'sticky', top: 0, zIndex: 1 }}>
            <h2 className="text-center text-2xl font-bold py-4 bg-white">{foro.name}</h2>
            <div className="border-t border-gray-400 mt-2"></div>
          </div>
          <div className="bg-white flex flex-col flex-1 overflow-y-auto rounded" style={{ minWidth: '690px', overflowX: 'hidden' }}>
